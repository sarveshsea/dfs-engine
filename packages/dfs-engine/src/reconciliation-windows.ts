...
export const SUPPORTED_RECONCILIATION_LEAGUES: readonly string[] =
  Object.keys(RECONCILIATION_WINDOW_MS);
...
export function isWithinReconciliationWindow(
  ...
  const settledMs = settledAt instanceof Date ? settledAt.getTime() : new Date(settledAt).getTime();
